...
*Please ensure your custom event names contain no more than 40 characters, contain only letters, numbers, hyphens and underscores, and do not start with a hyphen*. Facebook will not accept events that violate these rules.
