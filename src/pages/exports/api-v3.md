...
Branch’s new Data Export API for [Persona-Based Attribution](/pages/dashboard/persona-based-attribution/) can be used to pull granular Branch event data directly. A few important notes for this API:
