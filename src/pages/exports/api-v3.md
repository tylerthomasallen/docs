...
Branch’s new Data Export API for Unified Analytics can be used to pull granular Branch event data directly. A few important notes for this API:
...
All exports via Data Feeds are powered by Branch's [improved analytics platform](/pages/dashboard/unified-analytics). For an exhaustive list of events included in these exports and more detailed definitions of each event, please see the [Event Ontology Data Schema](/pages/exports/event_ontology_data_schema/).
