...
- #### Deep linking
    ...
    - Navigate to different locations based on device information
        ...
        | $one_time_use | `false` | Set to `true` to limit deep linking behavior of the generated link to a single use. Can also be set using type. Note: this parameter is currently not working
