...
- #### Hidden Pages
    ...
    - To not include a page in the navbar, add the page's title to the `hidden_pages` array in the mkdocs.yml. It must also be listed somewhere in the `pages:` section.
